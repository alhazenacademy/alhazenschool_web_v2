...
Route::get('/k-12/kindergarten', [LandingController::class, 'k_12_kindergarten'])->name('k-12-kindergarten');
Route::get('/k-12/primary-school', [LandingController::class, 'k_12_primary_school'])->name('k-12-primary-school');
Route::get('/k-12/junior-high-school', [LandingController::class, 'k_12_junior_high_school'])->name('k-12-junior-high-school');
Route::get('/k-12/high-school', [LandingController::class, 'k_12_high_school'])->name('k-12-high-school');
