<x-layout title="Title - Primary School - Hybrid Group Learning" description="Description - Primary School - Hybrid Group Learning" wa-message="Halo MinZen, Saya Mendapatkan Informasi dari Website. Saya Mau Konsultasi / Daftar Kelas di Alhazen School." :sales-phone="$salesPhone">
    ...
    <x-program.more.hero badge="Hybrid Learning" title='Balanced Islamic Hybrid Group <br class="hidden md:block">Education' description="Our hybrid group program combines online learning with face-to-face sessions, offering a balanced educational experience that supports academic growth, social development, and Islamic character building." image="{{ asset('assets/kids/program/more/hybrid-group-learning/hero-img.webp') }}" imageAlt="Hybrid Group Learning Image" floatingCardsText="Combining flexibility and structure for meaningful learning." />

    <x-program.more.why-program badge="Why Hybrid School?" title="The Best of Both Learning Worlds" descriptionOne="Parents often face a difficult choice between fully offline schooling that lacks flexibility and fully online programs that limit social interaction. Both options can leave gaps in a child’s academic, emotional, and social development." descriptionTwo="Alhazen School’s Hybrid Group program bridges this gap by blending structured in-person classes with guided online learning. Students benefit from direct teacher interaction, peer engagement, and flexible study time—creating a well-rounded and supportive learning experience." imageAlt="Why Hybrid School Image" />

    @php
        $objectives = [
            [
                'image' => asset('assets/kids/program/more/program-objective-img.webp'),
                'bg' => 'additional-blue',
