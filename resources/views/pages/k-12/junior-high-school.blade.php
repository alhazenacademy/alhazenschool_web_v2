<x-layout title="Title - K12 - Junior High School" description="Description - K12 - Junior High School" wa-message="Halo MinZen, Saya Mendapatkan Informasi dari Website. Saya Mau Konsultasi / Daftar Kelas di Alhazen School." :sales-phone="$salesPhone">
    <x-navbar variant="kids" />

    @php
        $badges = ['Islamic Manners', 'Independence', 'Creativity'];

        $title = "Alhazen Junior High School";

        $subtitle = "Primary Program (Grade 7 – 9)";

        $description = "Alhazen Junior High School is an Islamic educational institution that combines a strong Ahlus Sunnah wal Jama'ah foundation with modern academic excellence. Our curriculum integrates the Merdeka Curriculum, Islamic Studies, National Plus standards, and technology-driven innovation.
        <br> <br>
        As a pioneer of STEM-Q (Science, Technology, Engineering, Mathematics, and Qur'an) , we nurture a generation of Muslim scholars who are faithful, intelligent, and globally competitive.";
    ...
    <x-k-12.junior-school.core-principles />

    <x-k-12.junior-school.why-alhazen-school />
            ...
            [
                ...
                'features' => [
                    ...
                    [
                        ...
                        'value' => 'Tebet, South Jakarta • Ciputat, South Tangerang • Kendari, Southeast Sulawesi',
                        'type'  => 'icon',
                        'icon'  => '
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <x-k-12.junior-school.program-detail />

    <x-integrated-curriculum />

    <x-k-12.junior-school.weekly-lesson-allocation />

    <x-k-12.junior-school.activities-extracurriculars />

    <x-k-12.junior-school.weekly-timetable />

    <x-k-12.junior-school.learning-method />
        ...
        $subjectCards = [
            ...
            [
                ...
                'list' => [
                    ...
                    'Sirah Nabawi',
                    'Al-Qur’an Hadis',
                    'Bahasa Arab  (University of Madinah curriculum)',
                ],
    ...
    <x-k-12.junior-school.subjects-offered :subjectCards="$subjectCards" />

    <x-k-12.junior-school.official-status-certification />
