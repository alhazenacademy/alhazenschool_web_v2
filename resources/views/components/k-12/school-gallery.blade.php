@props([
    ...
    // daftar gambar kelas
    'images' => [
        asset('assets/kids/k-12/school-gallery/1.webp'),
        asset('assets/kids/k-12/school-gallery/7.webp'),
        asset('assets/kids/k-12/school-gallery/3.webp'),
        asset('assets/kids/k-12/school-gallery/9.webp'),
        asset('assets/kids/k-12/school-gallery/5.webp'),
    ],
])

<section id="k-12-school-gallery" class="relative py-16 sm:py-20">
