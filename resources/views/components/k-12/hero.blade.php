...
<section id="k-12-hero" class="relative overflow-hidden py-12 lg:py-20">
            ...
            <div>
                ...
                <div class="flex gap-2 mb-5">
                    @foreach ($badges as $badge)
                        <span
                            class="inline-flex items-center text-center px-3 py-1 text-small font-medium rounded-full border border-primary text-primary">
                            {{ $badge }}
                        </span>
                    @endforeach
                </div>
                ...
                <h3 class="text-h3 font-bold leading-tight mb-5 text-primary">
                    {!! $subtitle !!}
                </h3>
            ...
            <div class="flex-shrink-0 hidden md:block">
                <div class="relative">
                    <img src="{{ $image ?? asset('assets/kids/program/more/full-online-group-learning/hero-img.webp') }}"
                        alt="{{ $imageAlt }}" class="w-140 h-130 object-cover rounded-[32px] brightness-70">
